...
C      write(*,*)"pythia: ",ys, q2l, xs, nul, phil, e1
C      q2l=1
C      xs=0.1
C      ys=0.8
...
*     radiative photon
*
*        write(*,*)"dom=",dom,"dthg=",dthg,"dphig=",dphig
        deg=dom
        dthg=dtk
        dphig=dphk
...
*      write(*,*)"radgam: ",yrad, q2tr, xrad, anutr, genphi, erad
      end
...
C **********************************************************************
      ...
      data lun/66/
      open (unit=lun,file=tname, err=1000)
...
C I think this is how one does error handling in fortran?
      goto 1001
 1000  write (*,*) 'Make sure directory radgen exists and is readable.'
       call PYSTOP
